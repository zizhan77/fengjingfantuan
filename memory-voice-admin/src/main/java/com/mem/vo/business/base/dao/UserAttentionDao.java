...
public interface UserAttentionDao {
     ...
     * 添加接单中台表实体
     *
     * @param userAttention 回复接单中台表实体
     * @return 返回添加的接单中台表的ID
     */
    int insert(UserAttention userAttention);
     ...
     * @return 返回查询的集合
     */
    List<UserAttention> findByCondition(@Param("condition") UserAttentionQuery query);
     ...
     * @param query 查询条件
     */
    List<UserAttention> findByCondition(@Param("page") Page page, @Param("condition") UserAttentionQuery query);
